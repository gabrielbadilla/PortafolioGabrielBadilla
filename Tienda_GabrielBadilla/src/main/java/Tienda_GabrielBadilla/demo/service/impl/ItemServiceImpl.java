...
import Tienda_GabrielBadilla.demo.dao.FacturaDao;
import Tienda_GabrielBadilla.demo.dao.VentaDao;
...
import Tienda_GabrielBadilla.demo.dao.ProductoDao;
...
public class ItemServiceImpl implements ItemService {
    ...
    public void save(Item item) {
        ...
        for (Item i : listaItems) {//Busca si ya existe el producto en el carrito
    ...
    public void delete(Item item) {
        ...
        if (existe) {listaItems.remove(posicion);
        }
    }
